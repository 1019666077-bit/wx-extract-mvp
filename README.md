...
- Level 2 started: first ten lessons, `lle2-01` through `lle2-10` (Budget Cuts, The Interview, He Said - She Said, Run Away With the Circus!, Greatest Vacation of All Time, Will It Float?, Tip Your Tour Guide, The Best Barbecue, Pets Are Family, Too!, Visit to Peru)
...
```json
{
  ...
  "levels": [
    ...
    { "id": "lle2", "title": "Let's Learn English · Level 2", "lessons": [/* 10 so far */] }
  ]
}
```
...
In scope: catalog + fifty-two Level 1 lessons and the first ten Level 2 lessons, with local progress, check-in, a wrong-answer book, and a frontend redeem-code paywall.
