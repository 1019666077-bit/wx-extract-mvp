...
- Forty-five lessons: `lle1-01` through `lle1-45`
...
1. Open the catalog. Lessons 1–5 are free; 6–45 (and any later id with number > 5) show a lock badge until unlocked.
...
In scope: catalog + forty-five static lessons with local progress, check-in, a wrong-answer book, and a frontend redeem-code paywall.
