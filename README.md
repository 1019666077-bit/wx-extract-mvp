...
- Level 2 started: first fifteen lessons, `lle2-01` through `lle2-15` (Budget Cuts, The Interview, He Said - She Said, Run Away With the Circus!, Greatest Vacation of All Time, Will It Float?, Tip Your Tour Guide, The Best Barbecue, Pets Are Family, Too!, Visit to Peru, The Big Snow, Run! Bees!, Save the Bees!, Made for Each Other, Before and After)
...
```json
{
  ...
  "levels": [
    ...
    { "id": "lle2", "title": "Let's Learn English · Level 2", "lessons": [/* 15 so far */] }
  ]
}
```
...
In scope: catalog + fifty-two Level 1 lessons and the first fifteen Level 2 lessons, with local progress, check-in, a wrong-answer book, and a frontend redeem-code paywall.
